...
do
    ...
    /jet/home/hkittner/programs/muscle-linux-x86.v5.3 -align ${file1} -output ${out}_raw_concat_aln.faa
done
...
do
    ...
    /jet/home/hkittner/miniforge3/envs/trimal -in ${file1} -out ${out}_raw_concat_aln.faa -gt 0.05 -cons 60 
done
